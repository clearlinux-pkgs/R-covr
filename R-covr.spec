...
Version  : 3.4.0
Release  : 5
URL      : https://cran.r-project.org/src/contrib/covr_3.4.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/covr_3.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575283072
